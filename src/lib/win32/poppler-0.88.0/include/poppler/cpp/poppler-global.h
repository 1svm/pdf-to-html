...
#ifndef pdf-to-html_GLOBAL_H
#define pdf-to-html_GLOBAL_H
...
#if defined(pdf-to-html_cpp_EXPORTS)
#  define pdf-to-html_CPP_EXPORT LIB_EXPORT
#else
#  define pdf-to-html_CPP_EXPORT LIB_IMPORT
#endif
...
class pdf-to-html_CPP_EXPORT noncopyable
{
public:
...
#endif
class pdf-to-html_CPP_EXPORT ustring : public std::basic_string<unsigned short>
{
public:
    ustring();
...
pdf-to-html_CPP_EXPORT time_type convert_date(const std::string &date);

pdf-to-html_CPP_EXPORT std::ostream& operator<<(std::ostream& stream, const byte_array &array);

pdf-to-html_CPP_EXPORT bool set_data_dir(const std::string &new_data_dir);

typedef void(*debug_func)(const std::string &, void *);

pdf-to-html_CPP_EXPORT void set_debug_error_function(debug_func debug_function, void *closure);
