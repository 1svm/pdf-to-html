...
#ifndef pdf-to-html_PAGE_RENDERER_H
#define pdf-to-html_PAGE_RENDERER_H

#include "pdf-to-html-global.h"
#include "pdf-to-html-image.h"
...
class pdf-to-html_CPP_EXPORT page_renderer : public pdf-to-html::noncopyable
{
public:
    enum render_hint {
