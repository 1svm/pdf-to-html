...
#ifndef pdf-to-html_FONT_H
#define pdf-to-html_FONT_H
...
class pdf-to-html_CPP_EXPORT font_info
{
public:
    enum type_enum {
        unknown,
...
class pdf-to-html_CPP_EXPORT font_iterator : public pdf-to-html::noncopyable
{
public:
    ~font_iterator();
