...
#ifndef pdf-to-html_PAGE_H
#define pdf-to-html_PAGE_H

#include "pdf-to-html-global.h"
#include "pdf-to-html-rectangle.h"
...
class pdf-to-html_CPP_EXPORT text_box
{
    friend class page;
public:
...
class pdf-to-html_CPP_EXPORT page : public pdf-to-html::noncopyable
{
public:
