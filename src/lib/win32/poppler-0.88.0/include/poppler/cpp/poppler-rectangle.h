...
#ifndef pdf-to-html_RECTANGLE_H
#define pdf-to-html_RECTANGLE_H
...
pdf-to-html_CPP_EXPORT std::ostream& operator<<(std::ostream& stream, const rect &r);
pdf-to-html_CPP_EXPORT std::ostream& operator<<(std::ostream& stream, const rectf &r);
