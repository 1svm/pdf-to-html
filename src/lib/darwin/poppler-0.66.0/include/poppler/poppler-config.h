...
#ifndef pdf-to-html_CONFIG_H
#define pdf-to-html_CONFIG_H
...
/* Defines the pdf-to-html version. */
#ifndef pdf-to-html_VERSION
#define pdf-to-html_VERSION "0.66.0"
#endif
...
#ifndef pdf-to-html_HAS_CURL_SUPPORT
#define pdf-to-html_HAS_CURL_SUPPORT 1
#endif
...
// that are used but never defined when building pdf-to-html using configure
...
// copyright notice
#define pdf-to-htmlCopyright "Copyright 2005-2018 The pdf-to-html Developers - http://pdf-to-html.freedesktop.org"
