...
class pdf-to-html {
	/**
	 * @param {String=} binPath - Path of pdf-to-html-utils binaries.
	 * Useful for Linux users who have pdf-to-html-utils binaries already installed.
	 */
	constructor(binPath) {
		if (binPath) {
			this.pdf-to-htmlPath = binPath;
		} else {
			let pdf-to-htmlPath;

			// Build path to pdf-to-html binaries based on OS
			switch (platform) {
				// Windows OS
				case 'win32':
					pdf-to-htmlPath = path.join(
						__dirname,
						'lib',
						'win32',
						'pdf-to-html-0.88.0',
			...
			this.pdf-to-htmlPath = pdf-to-htmlPath;
		}
	}
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfattach'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfdetach'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
	 ...
	 * @param {Boolean=} options.listSubstitutes - List the substitute fonts that pdf-to-html
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdffonts'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfimages'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfinfo'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfseparate'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdftocairo'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
	 ...
	 * pdf-to-html will use the directory and name of the original file
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdftohtml'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdftoppm'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdftops'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdftotext'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
		...
		return new Promise((resolve, reject) => {
			...
			parseOptions(options, acceptedOptions, args).then(
				() => {
					...
					execFile(
						path.join(this.pdf-to-htmlPath, 'pdfunite'),
						args,
						(err, stdout) => {
							if (err) {
								reject(err);
