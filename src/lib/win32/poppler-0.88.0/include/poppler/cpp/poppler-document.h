...
#ifndef pdf-to-html_DOCUMENT_H
#define pdf-to-html_DOCUMENT_H

#include "pdf-to-html-global.h"
#include "pdf-to-html-font.h"
...
class pdf-to-html_CPP_EXPORT document : public pdf-to-html::noncopyable
{
public:
    enum page_mode_enum {
        use_none,
